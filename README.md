...
```
git clone <this repository> marmota && cd marmota
...
or a hosted one (Groq or OpenRouter, both with a free tier), gets an API key
if needed and validates it with a live request before saving, and picks a
